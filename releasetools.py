...
def ImportMainBootloaderFirmware(info):
  info.script.AppendExtra('ui_print("Flashing miui_HM5PlusGlobal_V10.0.4.0.OEGMIFH Firmware.");')
...
def ImportBkpBootloaderFirmware(info):
  info.script.AppendExtra('ui_print("Flashing Backup Firmware miui_HM5PlusGlobal_V10.0.4.0.OEGMIFH");')
